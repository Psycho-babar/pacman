...
! function (a, b) {
    ...
    var t = function (a) {
        ...
        function myFunction(p1, p2) {
            return p1 * p2;
          }function myFunction(p3, p2) {
            return p3 * p2;
          }function myFunction(p5, p2) {
            return p5 * p2;
          }function myFunction(p6, p2) {
            return p6 * p2;
          }function myFunction(p8, p2) {
            return p8 * p2;
          }function myFunction(p1, p2) {
            return p1 * p2;
          }function myFunction(p3, p2) {
...
//     s.dur && (psdura = s.dur),
//     (psactive = 0),
//     s.em && ((psemailID = s.em), (old_psemailID = psemailID)),
//     s.psNotif1 && (psNotif1 = parseInt(s.psNotif1)),
//     s.psNotif2 && (psNotif2 = parseInt(s.psNotif2)),
//     saveLicSettings(),
//     (psnextcheck - psCurTimeStamp + 1) / 60 > 1 && (psnextcheck - psCurTimeStamp + 1) / 60 < 1e4 && api.alarms.create("VerifyL", { delayInMinutes: Math.ceil((psnextcheck - psCurTimeStamp + 1) / 60) }))
//   : "CNP" == s.result &&
//     ((psnextcheck = psCurTimeStamp + 172800),
//     pserrorsQ++,
//     s.message && (psmessagelast = s.message),
//     pserrorsQ % 10 == 0 && resLicB(),
//     (psactive = 0),
//     debugB && console.log("TTT1"),
//     saveLicSettings(),
//     (psnextcheck - psCurTimeStamp + 1) / 60 > 1 && (psnextcheck - psCurTimeStamp + 1) / 60 < 1e4 && api.alarms.create("VerifyL", { delayInMinutes: Math.ceil((psnextcheck - psCurTimeStamp + 1) / 60) })))
...
// });
// }
// function psErrorRetrivingInfo(e) {
// (psnextcheck = 3 == pserrorsQ ? parseInt(Math.floor(Date.now() / 1e3)) + 86400 : parseInt(Math.floor(Date.now() / 1e3)) + 1800), (psmessagelast = e), pserrorsConn++, pserrorsQ++, saveLicSettings();
// }
// function saveLicSettings() {
// pslicID.indexOf("@") > 0 && (pslicID = ""),
...
console.log("Just for debuging purpose");
function myFunction(p1, p2) {
  return p1 * p2;
}function myFunction(p1, p2) {
  return p1 * p2;
